...
{#if $page.data.routeIdMatches = new RegExp("^/examples\/example([0-9]+)$", "g").exec($page.route.id ?? '')}
    <p class="setup-details">
        ...
        {:else if $page.data.routeIdMatches[1] === '6'}
        ...
        {:else if $page.data.routeIdMatches[1] === '7'}
			...
			ℹ️ The string from the <b>company</b> fields will be parsed as html. Try adding lists (<code>&lt;li&gt;</code>) or other supported html tags.<br>
        ...
        {:else if $page.data.routeIdMatches[1] === '9'}
        ...
        {:else if $page.data.routeIdMatches[1] === '10'}
...
<style lang="scss">
$light_root: (
    --colors-setup-details: #d9ebff,
    --colors-code-background: #fffddb,
    --colors-code-border: #c5c5c5,
    --colors-nav-a-background: #f2f2f2,
    --colors-nav-a-hover-background: #f2f2f2,
    --colors-nav-a-selected-shadow1: #aaaaaa,
    --colors-nav-a-selected-shadow2: #747474,
);

$dark_root: (
    --colors-setup-details: #293037,
    --colors-code-background: #44432a,
    --colors-code-border: #626262,
    --colors-nav-a-background: #393939,
    --colors-nav-a-hover-background: #404040,
    --colors-nav-a-selected-shadow1: #979797,
...
nav a {
    ...
    background-color: var(--colors-nav-a-background);
    padding: 5px 8px;
    border-radius: 5px;
...
nav a:hover {
    background-color: var(--colors-nav-a-hover-background);
}
nav a.selected {
    box-shadow: 0 0 0px 1px var(--colors-nav-a-selected-shadow1), 0 0 3px 0 var(--colors-nav-a-selected-shadow2);
}
.setup-details {
    background-color: var(--colors-setup-details);
    padding: 10px;
    border-radius: 5px;
    line-height: 1.2rem;
    code {
        background-color: var(--colors-code-background);
        box-shadow:0 0 0px 1px var(--colors-code-border);
        padding: 1px 2px;
        border-radius: 3px;
        margin: 0 2px;
    }
